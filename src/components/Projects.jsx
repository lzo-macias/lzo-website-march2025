    ...
    <div className='projectcontainer'>
      ...
      <div className='BookBuddy'>
        ...
        <img src="../public/img/BookBuddy.png" alt="BookBuddy App" />
          <div className='text_section'>
            <h3>BookBuddy</h3>
            <p>Solo development project for demo online bookstore. I used a test API provided by FullStack Academy to log books purchased and available. Secure password authentication among other features. Created with the PERN tech stack.</p>
          </div>
        </div>
      </div>
