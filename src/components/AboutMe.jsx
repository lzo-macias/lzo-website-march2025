  ...
  return (
    ...
    <div className='aboutme'>
        ...
        <p>
          ...
          className='aboutmelinks' target="_blank" rel="noopener noreferrer">college</a> I studied Computer Information Systems and Marketing. I got a job as a Customer Success Manager at the small corporate law firm 
          ...
          where I spent 4 months selling their POS product to NYC business owners. Upon graduation I became a certified Financial Advisor and Solutions Engineer at 
        ...
        <p>
          ...
          className='aboutmelinks' target="_blank" rel="noopener noreferrer"> CoolPeople </a> which uses scrapers and Ai to track local politics in NYC. I am most passionate about building projects that not only present well visually but follow development principles for security and organization. For fun I solve puzzles on AlgoExpert, cook, and on occasion maybe even a nightclub if my friends put me up to it.
        </p>
    </div>
    </Element>
  );
